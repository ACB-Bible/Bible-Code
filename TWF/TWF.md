...
[SQLite3](https://www.sqlite.org/) - SQLite3 which is a lightweight database engine, and it can be used for editing the TWF.db datadase with the Windows Terminal, Command Prompt, or Powershell. Editing the database this way requires knowledge of the SQLite3 version of the SQL database language.
